...
<tr>
	...
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>碱度单位</td>
	...
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>BOD5单位</td>
		</tr>
	...
	<s:hidden   value="3系列二沉池" name="dcsdatalist[0].equipment" theme="simple" />
	
	<s:hidden   value="3系列二沉池" name="dcsdatalist[1].equipment" theme="simple" />
	<s:hidden   value="3系列二沉池" name="dcsdatalist[2].equipment" theme="simple" />
	<s:hidden   value="3系列二沉池" name="dcsdatalist[3].equipment" theme="simple" />
	<s:hidden   value="3系列二沉池" name="dcsdatalist[4].equipment" theme="simple" />
	<s:hidden   value="3系列二沉池" name="dcsdatalist[5].equipment" theme="simple" />
	<s:hidden   value="3系列二沉池" name="dcsdatalist[6].equipment" theme="simple" />
	<s:hidden   value="3系列二沉池" name="dcsdatalist[7].equipment" theme="simple" />
	<s:hidden   value="3系列二沉池" name="dcsdatalist[8].equipment" theme="simple" />
	<s:hidden   value="3系列二沉池" name="dcsdatalist[9].equipment" theme="simple" />
	...
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>硝态氮单位</td>
		</tr>
		<tr>
	...
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>NO-N单位</td>
		</tr>
