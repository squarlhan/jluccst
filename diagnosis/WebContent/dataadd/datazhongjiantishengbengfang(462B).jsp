...
<tr>
	...
	<td align="left" style="width:200px">请选择班次</td>
	...
	<td align="right" >                                                               <!-- 向dcsdata录入的每个设备的各项参数，dcsdata中equipment在此设为隐藏的文本；
	                                                                               item为各项控制参数-->
	<s:textfield size="8" readonly="true" value="吸水池液位" name="dcsdatalist[1].item" theme="simple" style="width:150px;background:transparent;border:0px"/></td>
	...
	<tr>
	<td align="right">
	<s:textfield  readonly="true" value="V462B-3高位水池液位" name="dcsdatalist[2].item" theme="simple" style="width:150px;background:transparent;border:0px"/></td>
	...
	<s:textfield  readonly="true" value="462B地面污水池液位" name="dcsdatalist[3].item" theme="simple" style="width:150px;background:transparent;border:0px"/></td>
	...
	<s:textfield  readonly="true" value="PH" name="dcsdatalist[4].item" theme="simple" style="width:150px;background:transparent;border:0px"/></td>
