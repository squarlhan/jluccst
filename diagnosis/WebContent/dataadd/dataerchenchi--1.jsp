...
<tr>
	...
	<s:hidden   value="1系列二沉池" name="dcsdatalist[0].equipment" theme="simple" />
	
	<s:hidden   value="1系列二沉池" name="dcsdatalist[1].equipment" theme="simple" />
	<s:hidden   value="1系列二沉池" name="dcsdatalist[2].equipment" theme="simple" />
	<s:hidden   value="1系列二沉池" name="dcsdatalist[3].equipment" theme="simple" />
	<s:hidden   value="1系列二沉池" name="dcsdatalist[4].equipment" theme="simple" />
	<s:hidden   value="1系列二沉池" name="dcsdatalist[5].equipment" theme="simple" />
	<s:hidden   value="1系列二沉池" name="dcsdatalist[6].equipment" theme="simple" />
	<s:hidden   value="1系列二沉池" name="dcsdatalist[7].equipment" theme="simple" />
	<s:hidden   value="1系列二沉池" name="dcsdatalist[8].equipment" theme="simple" />
	<s:hidden   value="1系列二沉池" name="dcsdatalist[9].equipment" theme="simple" />
