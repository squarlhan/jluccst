				...
				<td>
					<table width="100%" style="height: 100%;" border="2" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							%>
							<td width="200" valign="top" style="border-left: 1px solid #54a4e3; border-bottom: 1px solid #54a4e3; border-right: 1px solid #54a4e3; padding: 5px;"><iframe width="100%" height="100%" id="menutree" name="menutree"frameborder="0" scrolling="auto" src="<%=path %>/showGroupTreeForSellTargetStatAction.action"></iframe></td>
							<%}
							...
							<td valign="top" style="border-left: 1px solid #54a4e3; border-bottom: 1px solid #54a4e3; border-right: 1px solid #54a4e3; padding: 5px;">
								<iframe width="100%" height="100%" id="groupmain" name="groupmain" frameborder="0" scrolling="auto" src="openSellReportStatTargetAction.action?companyId=<%=companyId %>&deptId=<%=deptId %>&statYear=<%=Calendar.getInstance().get(Calendar.YEAR)%>"></iframe>
							</td>
							<%}else{ %>
								<td valign="top" style="border-left: 1px solid #54a4e3; border-bottom: 1px solid #54a4e3; border-right: 1px solid #54a4e3; padding: 5px;">
									<iframe width="100%" height="100%" id="groupmain" name="groupmain" frameborder="0" scrolling="auto" src="openSellReportStatTargetAction.action?companyId=<%=companyId %>&statYear=<%=Calendar.getInstance().get(Calendar.YEAR)%>"></iframe>
								</td>
							<%} %>
						</tr>
					</table>
