...
<div class="dtree">
  ...
  <script type="text/javascript">
		...
		<s:iterator value="userList">
			d.add("<s:property value="id"/>","<s:property value="deptId"/>",'<s:property value="userCName"/>','./openSellTrendAction.action?companyId=<s:property value="companyId"/>&deptId=<s:property value="deptId"/>&personId=<s:property value="id"/>&statYear=<%=Calendar.getInstance().get(Calendar.YEAR)%>','','groupmain','<%=path%>/js/tree/img/user.gif');
		</s:iterator>
		document.write(d);
		//-->
	</script>
