		...
		<script type="text/javascript">
			...
			$.fn.reference = function(){
				$("#referenceBtn").click(function() {
		            form1.action = "openAddMonthlyMainInfoAction.action?reference=true";					
	               	form1.submit();
          		});
          	};
								...
								<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="3">
											<span onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();"> 
												<s:textfield id="txt_position" name="monthlyMainInfo.position" cssStyle="width: 160px;" maxlength="25" readonly="true"></s:textfield>
											</span>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td height="26" colspan="8" align="center" bgcolor="#FFFFFF">
											<s:if test="monthlyMainInfo.id==null">
											 	<!-- 
