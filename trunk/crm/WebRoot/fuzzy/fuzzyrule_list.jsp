		...
		$(function(){
			...
			$("#addbtn").click(function(){
				...
				parent.parent.$("#windown-close").bind('click',function(){
					window.location.href="fuzzy/fuzzyRuleList.action?fuzzyCategory=<s:property value='fuzzyCategory' />";
				});
			});
								...
								<tr>
									...
									<td height="26" align="center" bgcolor="#FFFFFF">
										...
										<s:iterator value="attachObject" status="obj1">
											<s:property value="fuzzyCategoryName" />&nbsp;&nbsp;<s:property value="ifFuzzyName" /></span>
									...
									<td height="26" align="center" bgcolor="#FFFFFF">
										<span class="showInfo" tid="<s:property value='id' />"><s:property value="caption" /></span>
										&nbsp;
									</td>
								</tr>
							</s:iterator>
