		...
		<script type="text/javascript">
			...
			var _customer_submit = {
				rules: {
					...
					"actionPlan.planContent":{required:true,strangecode:false},
								...
								<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF">
											<span onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();"> 
												<s:select id="sel_employee"   name="actionPlan.employeeId" list="userList"  listKey="id"  listValue="userCName"  cssStyle="width: 160px;" ></s:select>
											</span>
										</td>
										<td height="26" align="right" bgcolor="#FFFFFF">
											<strong>所属部门：</strong>
										...
										<td height="26" align="left" bgcolor="#FFFFFF">
											<span onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();"> 
												<s:select id="sel_dept"  name="actionPlan.deptId" list="deptList" listKey="id"  listValue="deptName" cssStyle="width: 160px;" ></s:select>
											</span>
										</td>
									</tr>
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF">
											<s:textfield id="txt_submitTime" name="actionPlan.submitTime" cssStyle="width: 160px;" maxlength="25"></s:textfield>
											<font color="red">*</font>
										</td>
									</tr>
									...
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="3">
											<s:textarea  id="txt_memo" name="actionPlan.memo" cssStyle="width: 438px;height:100px;resize:none;" maxlength="500"></s:textarea>
										</td>
									</tr>
									<tr>
										<td height="26" align="right" bgcolor="#FFFFFF">
										...
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="3">
											<s:textarea  id="txt_planContent" name="actionPlan.planContent" cssStyle="width: 438px;height:100px;resize:none;" maxlength="500"></s:textarea>
											<font color="red">*</font>
										</td>
									</tr>
									<tr>
