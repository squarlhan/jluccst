			...
			<tr>
				<td>
					<table width="100%" style="height: 100%;" border="0"
								...
								<table id="__01" width="100%" height="36" border="0"
									...
									<tr>
										...
										<td background="../images/header_02.jpg">
											<span class="STYLE1">您当前的位置：我的客户管理&gt;&gt;&gt;我的销售</span>
										</td>
										<td width="12">
						...
						<tr>
							<td valign="top" style="border-left: 1px solid #54a4e3; border-bottom: 1px solid #54a4e3; border-right: 1px solid #54a4e3; padding: 5px;"><iframe width="100%" height="100%" id="groupmain" name="groupmain" frameborder="0" scrolling="auto" src="<%=path %>/queryCustomerBySellAmountForEditAction.action?deptId=<%=deptId %>&salesmanId=<%=salesmanId %>"></iframe></td>
						</tr>
					</table>
				</td>
			</tr>
