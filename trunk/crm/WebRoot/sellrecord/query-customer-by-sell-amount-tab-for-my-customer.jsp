...
<div id="tt" class="tabs-container">
	<div id="tab1" title="销售记录查看"  style="padding: 1px; display: none;">
		<iframe id="iframe1" scrolling="auto" frameborder="0" style="width:100%; height:100%" src="openSellRecordListForMyCustomerAction.action?customerId=<%=customerId%>&hasReturn=<%=hasReturn %>" ></iframe>
	</div>
