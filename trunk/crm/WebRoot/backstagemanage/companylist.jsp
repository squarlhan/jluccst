	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				parent.parent.tipsWindown("添加公司档案","iframe:openAddCompanyAction.action","540","500","true","","true","no");
			...
			$.fn.checkall("cbk_all");
	  		...
	  		$('a[name="edit"]').each(function(){
	  			$(this).click(function(){
	  				...
	  				parent.parent.tipsWindown("修改公司档案","iframe:"+url,"540","500","true","","true","no");
	  				parent.parent.$("#windown-close").bind('click',function(){
						window.location.href="./openCompanyAction.action";
					});
	  			});
        ...
        <tr>
         <td align="center" background="<%=path %>/images/headerbg.jpg">  
              ...
              <td align="center" background="<%=path %>/images/headerbg.jpg"><strong>公司电话</strong></td>
               ...
               <td align="center" background="<%=path %>/images/headerbg.jpg"><strong>产品类型</strong></td>
        	...
        	<s:else>
              ...
              <td height="26" align="center" bgcolor="#FFFFFF"><s:property value="address"/></td>
                ...
                <td height="26" align="center" bgcolor="#FFFFFF"><s:property value="trialFlagCn" escape="false"/></td>
                   <td height="26" align="center" bgcolor="#FFFFFF"><s:property value="productTypeCn" escape="false"/></td>
