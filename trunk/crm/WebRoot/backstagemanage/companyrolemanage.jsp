        ...
        <tr>
          <td colspan="2" style="height:36px;"><table id="__01" width="100%" height="36" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td background="../images/header_02.jpg"><span class="STYLE1">您当前的位置：系统管理&gt;&gt;&gt;职务管理</span></td>
        ...
        <tr>
        	<!-- 
          	<td valign="top" style="border-left:1px solid #54a4e3; border-bottom:1px solid #54a4e3; border-right:1px solid #54a4e3; padding:5px;"><iframe width="100%" height="100%"
          	 id="groupmain" name="groupmain" frameborder="0" scrolling="auto" src="./openRoleAction.action"></iframe>
          	 </td>
          	 -->
          	 <td width="200" valign="top" style="border-left: 1px solid #54a4e3; border-bottom: 1px solid #54a4e3; border-right: 1px solid #54a4e3; padding: 5px;"><iframe width="100%" height="100%" id="menutree" name="menutree"frameborder="0" scrolling="auto" src="./companyAction!showCompanyTreeForRole.action"></iframe></td>
