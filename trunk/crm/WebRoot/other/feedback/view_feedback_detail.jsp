								...
								<td style="height: 36px;">
									<table width="100%" border="0" cellpadding="5" cellspacing="1"
										...
										<tr>
											...
											<td height="26" align="left" bgcolor="#FFFFFF">
												<s:textarea name="suggestionReply.content" id="suggestionReply" cssStyle="width: 450px;" rows="5" readonly="true"></s:textarea>
											</td>
										</tr>
										<tr>
											<td height="26" align="right" bgcolor="#FFFFFF">
										...
										<tr>
											...
											<td height="26" align="left" bgcolor="#FFFFFF" nowrap="nowrap">
												<s:property value="suggestionReply.userName"/>
											</td>
										</tr>
										<tr>
