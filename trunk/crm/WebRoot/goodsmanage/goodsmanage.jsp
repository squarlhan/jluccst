...
-->
	...
	<body>
		<table width="100%" style="height: 100%;" border="0" cellspacing="5"
			cellpadding="0">
			<tr>
				<td><table width="100%" style="height: 100%;" border="0"
						cellspacing="0" cellpadding="0">
						<tr>
							<td colspan="2" style="height: 36px;"><table id="__01" width="100%" height="36" border="0"
									cellpadding="0" cellspacing="0">
									<tr>
										<td width="11"><img src="../images/header_01.jpg" width="11" height="36"
												alt=""></td>
										<td background="../images/header_02.jpg">
											<span class="STYLE1">您当前的位置：进销存管理&gt;&gt;&gt;产品管理</span>
										</td>
						...
						<tr>
							<td width="200" valign="top"
								...
								<iframe width="100%" height="100%" id="goodstree" name="goodstree"
									frameborder="0" scrolling="auto" src="<%=path %>/goodsmanage/goodstypetreeview.action"></iframe>
							</td>
							<td valign="top"
								style="border-left: 1px solid #54a4e3; border-bottom: 1px solid #54a4e3; border-right: 1px solid #54a4e3; padding: 5px;">
								<iframe width="100%" height="100%" id="groupmain"
									name="goodsmain" frameborder="0" scrolling="auto"
