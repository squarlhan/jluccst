	...
	var _customer_submit = {
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				parent.parent.parent.tipsWindown("添加跟进信息","iframe:customer/myCustomerTraceInfo.action?customerId=<s:property value='customerId'/>","850","550","true","","true","no");
			...
			$("#searchBtn").click(function(){
				...
				form1.action = "myCustomerTraceList.action?customerId=<s:property value='customerId'/>";
				form1.submit();
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
        ...
        <td height="26" align="center" bgcolor="#FFFFFF" >  
          ...
          <td height="26" colspan="2" align="center" bgcolor="#FFFFFF">
          	<s:url id="edit_url" action="customer/myCustomerTraceInfo.action">   
