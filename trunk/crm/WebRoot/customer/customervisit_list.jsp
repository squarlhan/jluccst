	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				parent.parent.parent.tipsWindown("添加回访信息","iframe:customer/customerVisitInfo.action?customerId=<s:property value='customerId'/>","800","500","true","","true","no");
			...
			$("#searchBtn").click(function(){
				...
				form1.action = "customerVisitList.action?customerId=<s:property value='customerId'/>";
				form1.submit();
