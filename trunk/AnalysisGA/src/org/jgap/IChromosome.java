...
/**
 * Interface for chromosomes. Normally, you would start using BaseChromosome
 * which implements this interface to build your own chromosome classes.
 * 
...
public interface IChromosome extends Comparable, ICloneable, Serializable,
	 ...
	 * 
	 * @param a_desiredLocus
	 *            index of the gene value to be returned
	 ...
	 * @since 2.6
	 */
	void setGenes(Gene[] a_genes) throws InvalidConfigurationException;

	/**
	 * Returns the size of this Chromosome (the number of genes it contains). A
	 * Chromosome's size is constant and will not change, until setGenes(...) is
	 * used.
	 * 
	...
	/**
	 * @param a_age
	 *            set the age of the chromosome, see BestChromosomesSelector for
	 *            a use-case
	 * 
	 * @author Klaus Meffert
	 * @since 3.3.3
