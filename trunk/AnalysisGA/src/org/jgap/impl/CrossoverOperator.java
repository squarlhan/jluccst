...
public class CrossoverOperator
  ...
  public void operate(final Population a_population,
    ...
    for (int i = 0; i < numCrossovers; i++) {
      ...
      //保存该个体在群体中的标号
      chrom1.setIndex(index1);
      chrom2.setIndex(index2);
  ...
  protected void doCrossover(IChromosome firstMate, IChromosome secondMate,
	  ...
	  int index1 = firstMate.getIndex();
	  int index2 = secondMate.getIndex();
    ...
    // phase of evolution.
    // -----------------------------------------------------------
    firstMate.setIndex(-1);
    secondMate.setIndex(-1);
    firstMate.setPap(index1);
    firstMate.setMom(index2);
    secondMate.setPap(index1);
    secondMate.setMom(index2);
