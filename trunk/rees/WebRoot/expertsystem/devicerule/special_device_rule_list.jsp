	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				...
				parent.parent.tipsWindown("添加设备规则","iframe:openAddSpecialDeviceRuleAction.action?"+param ,"480","420","true","","true","no");
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
        <tr>
         <td  width="5%"  align="center"  background="<%=path %>/images/headerbg.jpg">  
          ...
          <td width="10%" align="center" background="<%=path %>/images/headerbg.jpg"><strong>设备型号</strong></td>
