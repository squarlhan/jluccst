		...
		$(function(){
			...
			$.fn.checkall("cbk_all");
	  		...
	  		$("#deleteselectedbtn").click(function(){
  				var url = "deleteResultAction.action";
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
        <tr>
         <td width="10%" align="center" background="../images/headerbg.jpg">  
          ...
          <td width="30%" align="center" background="../images/headerbg.jpg"><strong>现象描述</strong></td>
        ...
        <tr>
          ...
          <td height="26" colspan="2" align="center" bgcolor="#FFFFFF" nowrap>
          	<s:url id="edit_url" action="openModifyResultAction">   
				<s:param name="ruleResultInfo.id" value="id"></s:param>   
			</s:url>
			<s:url id="delete_url" action="deleteResultAction">   
