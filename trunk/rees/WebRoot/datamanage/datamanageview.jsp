    ...
    <td><table width="100%" style="height:100%;" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2" style="height:36px;"><table id="__01" width="100%" height="36" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td background="../images/header_02.jpg"><span class="blackBold">您当前的位置：数据管理&gt;&gt;&gt;数据查看</span></td>
        ...
        <tr>
          <td width="200" valign="top" style="border-left:1px solid #54a4e3; border-bottom:1px solid #54a4e3; border-right:1px solid #54a4e3; padding:5px;">
          	<iframe width="100%" height="100%" id="devicetree" name="devicetree" frameborder="0" scrolling="auto" src="${pageContext.request.contextPath}/groupTreeAction!showGroupTreeForPointDataView.action"></iframe></td>
