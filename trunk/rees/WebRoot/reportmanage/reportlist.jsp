...
<html>
	...
	$(function() {
		...
		$("#addbtn").click(
				function() {
					parent.parent.parent.tipsWindown("添加汇报",
							"iframe:openAddReportAction.action", "600", "425",
							"true", "", "true", "no");
				});
				...
				function() {
					$(this).click(
							function() {
								...
								parent.parent.parent.tipsWindown("修改报表信息",
										"iframe:" + url, "600", "425", "true",
										"", "true", "no");
							});
				});
		...
		$('a[name="delete"]').each(function() {
			$(this).click(function() {
				...
				if (window.confirm("您确定要删除这条信息吗？")) {
					$.post(url, $('#repform').serialize(), function(data) {
		...
		$("#deletepointbtn").click(function() {
			...
			if (window.confirm("您确定要删除所选信息吗？")) {
				$.post(url, $('#replist').serialize(), function(data) {
					window.location.href = window.location.href;
				});
			}
		});
				...
				<tr>
					<td valign="top">
						<table width="100%" border="0" cellspacing="5" cellpadding="0">
							<tr>
								<td>
									<input name="addbtn" type="button" class="btn_4" id="addbtn"
										value="添加">
