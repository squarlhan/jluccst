		...
		<script type="text/javascript">
			...
			$.fn.save = function(){
				$("#addBtn").click(function() {
					...
					if( $.trim( $("#workshopId").val() ) != ""){
						form1.action = "toModifyWorkshopAction.action";
					}else{
								...
								<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
									...
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF">
											<s:textfield id="txt_workshopName" name="workshop.workshopName" cssStyle="width: 250px;" maxlength="25"></s:textfield>
											<font color="red">*</font>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF">
											<s:textfield id="txt_phone" name="workshop.phone" cssStyle="width: 250px;" maxlength="100"></s:textfield>
										</td>
									</tr>
									<tr>
