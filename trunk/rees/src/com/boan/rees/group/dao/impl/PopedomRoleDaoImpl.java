...
public class PopedomRoleDaoImpl extends BaseDao<PopedomRole,String> implements IPopedomRoleDao{
	...
	@Override
	public void delete(PopedomRole entity) {
		// TODO Auto-generated method stub
		super.delete(entity);
	}
	...
	@Override
	public List<PopedomRole> get(Collection<String> ids) {
		// TODO Auto-generated method stub
		return super.get(ids);
	}

	@Override
	public List<PopedomRole> findAll() {
		// TODO Auto-generated method stub
		return super.findAll();
	}

	@Override
	public List<PopedomRole> findAll(String orderByProperty, boolean isAsc) {
		// TODO Auto-generated method stub
		return super.findAll(orderByProperty, isAsc);
	}

	@Override
	public List<PopedomRole> findByProperty(String propertyName,
			Object value) {
		// TODO Auto-generated method stub
