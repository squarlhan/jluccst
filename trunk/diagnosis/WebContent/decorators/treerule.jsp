  ...
  <body>
   ...
   <div class="CNLTreeMenu" id="CNLTreeMenu2"  style="   margin-top:36px; width:180px;margin-left:0px;overflow-y:auto;height: 360px; width: 200px;  ">
							<p>
							    ...
							    <ul>
							  <li class="Closed"><a href="/diagnosis/ruleaction!findbynamep?unit=<%=java.net.URLEncoder.encode("点源处理","UTF-8")%>">点源处理</a>
							    <ul>
							  ...
							  <li class="Closed"><a href="/diagnosis/ruleaction!findbynamep?unit=<%=java.net.URLEncoder.encode("中和处理","UTF-8")%>">中和处理</a>
							   <ul>
							  ...
							  <li class="Closed"><a href="/diagnosis/ruleaction!findbynamep?unit=<%=java.net.URLEncoder.encode("生活水处理","UTF-8")%>">生活水处理</a>
							   <ul>
							    <li class="Child"><a href="/diagnosis/ruleaction!findbyname?name=<%=java.net.URLEncoder.encode("14a生活水","UTF-8")%>">14a工业水</a></li>
							   <li class="Child"><a href="/diagnosis/ruleaction!findbyname?name=<%=java.net.URLEncoder.encode("14b生活水","UTF-8")%>">14b生活水</a></li>
							    </ul>
							  </li>
							  <li class="Closed"><a href="/diagnosis/ruleaction!findbynamep?unit=<%=java.net.URLEncoder.encode("预处理","UTF-8")%>">预处理</a>
							    <ul>
								...
								<li class="Closed"><a href="/diagnosis/ruleaction!findbynamep?unit=<%=java.net.URLEncoder.encode("生化处理","UTF-8")%>">生化处理</a>
									<ul>
										 <li class="Child"><a href="/diagnosis/ruleaction!findbyname?name=<%=java.net.URLEncoder.encode("1系列465回流泵房","UTF-8")%>">1系列465回流泵房</a></li>
								         <li class="Child"><a href="/diagnosis/ruleaction!findbyname?name=<%=java.net.URLEncoder.encode("2系列465A回流泵房","UTF-8")%>">2系列465A回流泵房</a></li>
										 ...
										 <li class="Child"><a href="/diagnosis/ruleaction!findbyname?name=<%=java.net.URLEncoder.encode("鼓风机","UTF-8")%>">鼓风机</a></li>
