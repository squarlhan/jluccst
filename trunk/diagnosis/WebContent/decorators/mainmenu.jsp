  ...
  <body>
    <table align="center" width="1280" id="nav">
     <tr align="center">
         ...
         <td><a href="/diagnosis/biocpool490/biocpool1.jsp">数据推理</a></td>
         <td><a href="/diagnosis/dcsdataaction!showdcsdata.action">数据查询</a></td>
        <td><a href="/diagnosis/errorlogaction.action">报警日志</a></td>
