...
<tr>
	...
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>回流量单位</td>
	...
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>剩余量单位</td>
	...
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>吸泥池液位单位</td>
	
	</tr>
	
	<tr>
	<td align="right">
	<s:textfield  readonly="true" value="污水池液位" name="dcsdatalist[4].item" theme="simple" style="background:transparent;border:0px"/></td>
	<td align="center"><s:textfield name="dcsdatalist[4].value" theme="simple"
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>污水池液位单位</td>
	...
	<s:hidden   value="3系列465B回流泵房" name="dcsdatalist[0].equipment" theme="simple" />
	
	<s:hidden   value="3系列465B回流泵房" name="dcsdatalist[1].equipment" theme="simple" />
	<s:hidden   value="3系列465B回流泵房" name="dcsdatalist[2].equipment" theme="simple" />
	<s:hidden   value="3系列465B回流泵房" name="dcsdatalist[3].equipment" theme="simple" />
	<s:hidden   value="3系列465B回流泵房" name="dcsdatalist[4].equipment" theme="simple" />
