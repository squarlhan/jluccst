...
<tr>
	...
	<s:hidden   value="巴氏计量槽" name="dcsdatalist[1].equipment" theme="simple" />
	<s:hidden   value="巴氏计量槽" name="dcsdatalist[2].equipment" theme="simple" />
	<s:hidden   value="巴氏计量槽" name="dcsdatalist[3].equipment" theme="simple" />
	<s:hidden   value="巴氏计量槽" name="dcsdatalist[4].equipment" theme="simple" />
