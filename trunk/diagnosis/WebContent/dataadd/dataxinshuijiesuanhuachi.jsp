...
<tr>
	...
	onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"/></td><td>m3/h</td>
		...
		<tr>
	<td align="right"><s:textfield  readonly="true" value="新水解酸化池液位" name="dcsdatalist[10].item" theme="simple" style="background:transparent;border:0px"/></td>
	...
	<s:hidden   value="新水解酸化池" name="dcsdatalist[1].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[2].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[3].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[4].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[5].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[6].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[7].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[8].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[9].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[10].equipment" theme="simple" />
	<s:hidden   value="新水解酸化池" name="dcsdatalist[0].equipment" theme="simple" />
