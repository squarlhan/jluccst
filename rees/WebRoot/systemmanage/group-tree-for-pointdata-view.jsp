...
<div class="dtree">
  ...
  <script type="text/javascript">
		...
		<s:iterator value="workshopList">
			d.add("<s:property value="id"/>","<s:property value="factoryId"/>",'<s:property value="workshopName"/>','<%=path%>/datamanage/devicelistview.action?factoryId=<s:property value="factoryId"/>&workshopId=<s:property value="id"/>','','devicemanage','');
		</s:iterator>
		document.write(d);
		//-->
	</script>
