	...
	<script type="text/javascript">
		...
		$(function(){
			$("#addbtn").click(function(){
				parent.parent.tipsWindown("添加角色信息","iframe:openAddRoleAction.action","460","200","true","","true","no");
			...
			$.fn.checkall("cbk_all");
	  		...
	  		$('a[name="edit"]').each(function(){
	  			$(this).click(function(){
	  				...
	  				parent.parent.tipsWindown("修改角色信息","iframe:"+url,"460","200","true","","true","no");
	  				parent.parent.$("#windown-close").bind('click',function(){
						window.location.href="./openRoleAction.action";
					});
	  			});
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
        <tr>
         <td align="center" background="../images/headerbg.jpg">  
              ...
              <td align="center" background="../images/headerbg.jpg"><strong>角色名称</strong></td>
