	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				...
				parent.parent.tipsWindown("添加建议","iframe:openAddAdviceAction.action","480","420","true","","true","no");
				parent.parent.$("#windown-close").bind('click',function(){
					window.location.href="./openRuleAdviceAction";
				});
			});
			$.fn.checkall("cbk_all");
	  		...
	  		$('a[name="edit"]').each(function(){
	  			$(this).click(function(){
	  				...
	  				parent.parent.tipsWindown("修改建议","iframe:"+url,"480","420","true","","true","no");
	  				parent.parent.$("#windown-close").bind('click',function(){
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
        <tr>
         <td width="10%" align="center" background="../images/headerbg.jpg">  
          ...
          <td width="30%" align="center" background="../images/headerbg.jpg"><strong>建议描述</strong></td>
