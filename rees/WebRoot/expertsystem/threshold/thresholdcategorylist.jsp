...
<html>
	<head>
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				parent.parent.tipsWindown("添加阈值类别","iframe:openAddThresholdCategoryAction.action","400","150","true","","true","no");
			...
			$('a[name="edit"]').each(function(){
				$(this).click(function(){
					...
					parent.parent.tipsWindown("修改阈值类别","iframe:"+url,"400","150","true","","true","no");
					parent.parent.$("#windown-close").bind('click',function(){
						window.location.href=window.location.href;
					});
				});
			...
			$("#deletepointbtn").click(function(){
				var url = "deleteThresholdCategoryAction.action";
	...
	<body>
		<s:form action="openThresholdCategoryAction" id="dtplist" method="post" theme="simple">
					...
					<td valign="top">
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
							<tr>
								...
								<td width="30%" align="center" background="<%=path %>/images/headerbg.jpg">
									<strong>创建时间</strong>
								</td>
							...
							<s:iterator value="pagination.data" status="obj">
								<tr>
									...
									<td height="26" colspan="2" align="center" bgcolor="#FFFFFF">
										<s:url id="edit_url" action="openModifyThresholdCategoryAction">
											<s:param name="thresholdCategory.id" value="id"></s:param>
										</s:url>
										<s:url id="delete_url" action="deleteThresholdCategoryAction">
