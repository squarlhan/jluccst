  ...
  <head>
	...
	<script type="text/javascript">
		...
		var _ThresholdCategory_submit = {
			rules: {
               "thresholdCategory.categoryName":{required:true,maxlength:20}
			},messages:{
				"thresholdCategory.categoryName":
				{
					required:"类别名称为必填项！",
					maxlength:"类别名称最多输入20个字符！"
				}
			}
		};
		...
		$.fn.save = function(){
			...
			//如果有id就说明是修改action
			var ThresholdCategory = $("#hid_thresholdCategoryId").val();
				...
				var validate_settings_submit = jQuery.extend({}, _ThresholdCategory_submit);
               	...
               	{
               		repform.action = "toAddThresholdCategoryAction.action";
               	}
               	else
               	{
	               	repform.action = "toModifyThresholdCategoryAction.action";
               	}
               	repform.submit();
           	});
         	}
...
<body>
	<s:form  id="repform"  theme="simple" >
		...
		<s:hidden id="hid_thresholdCategoryId" name="thresholdCategory.id"></s:hidden>
		<s:hidden id="hid_createTime" name="thresholdCategory.createTime"></s:hidden>
								...
								<table id="table1" width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF">
											<s:textfield id="txt_categoryName" name="thresholdCategory.categoryName" maxlength="25" cssStyle="width: 250px;"/><font color="red">*</font>
										</td>
									</tr>
									<tr>
