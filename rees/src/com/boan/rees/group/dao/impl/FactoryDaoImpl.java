...
public class FactoryDaoImpl extends BaseDao<Factory,String> implements IFactoryDao{
	...
	@Override
	public List<Factory> get(Collection<String> ids) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Factory> findAll(String orderByProperty, boolean isAsc) {
		// TODO Auto-generated method stub
		return super.findAll(orderByProperty, isAsc);
	}

	@Override
	public List<Factory> findByProperty(String propertyName, Object value) {
		// TODO Auto-generated method stub
