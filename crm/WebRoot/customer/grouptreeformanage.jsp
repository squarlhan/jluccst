...
<div class="dtree">
  ...
  <script type="text/javascript">
		...
		<s:iterator value="deptList">
			d.add("<s:property value="id"/>",0,'<s:property value="deptName"/>','customerList.action?companyId=<s:property value="commpanyId"/>&deptId=<s:property value="id"/>&who=session','','groupmain','');
		</s:iterator>
		document.write(d);
		//-->
	</script>
