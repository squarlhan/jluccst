  ...
  <tr>
    <td><table id="__01" width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td background="../images/header_02.jpg"><span class="STYLE1">您当前的位置：我的客户管理&gt;&gt;&gt;客户详细信息</span></td>
...
<div id="tt" class="tabs-container" style="width:100%">
	...
	<div title="客户跟进"
		...
		<iframe id="traceDivFrame" scrolling="auto" frameborder="0" style="width:100%; height:100%"
			src="about:blank" url="myCustomerTraceList.action?customerId=<s:property value='id'/>"></iframe>
	</div>
	<div title="销售记录"
		style="padding: 1px; display: none;">
		<iframe scrolling="auto" frameborder="0" style="width:100%; height:100%"
	...
	<div title="客户评估"
		style="padding: 1px; display: none;">
		<iframe scrolling="auto" frameborder="0" style="width:100%; height:100%"
			src="about:blank" url="../customerassessment/staticAnalysisCustomer.action?customerId=<s:property value='id'/>&option=mycustomer"></iframe>
	</div>
	</s:if>
</div>
</body>
