      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
        <tr>
         <td align="center" background="../images/headerbg.jpg">  
              ...
              <td align="center" background="../images/headerbg.jpg"><strong>预计回访日期</strong></td>
              <td align="center" background="../images/headerbg.jpg"><strong>实际回访日期</strong></td>
			...
			<td align="center" style="height: 26px; background-image:url('../images/headerbg.jpg')">内容及结果</td>
			<td align="center" style="height: 26px; background-image:url('../images/headerbg.jpg')">备注</td>
