	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$("#customerName").autocomplete("customer/getCustomerByName.action?type=trace",
			     {
		           minChars: 1,
		           max:5,
		           width: 150, 
...
<tr><td width="15px"></td><td align="center" nowrap>实际<br/>跟进时间：</td>
	...
	<tr>
		...
		<td  style="padding-left:12px">
			...
			<s:else>
				<s:textarea title="请于跟进结束后填写" readOnly="true" type="text" style="width:630px;height:70px" name="customerTraceInfo.interest" id="interest"></s:textarea></td>
			</s:else>
	</tr>
	<tr>
		...
		<td style="padding-left:12px">
			...
			<s:else>
			<s:textarea title="请于跟进结束后填写" type="text" readOnly="true" style="width:630px;height:70px" name="customerTraceInfo.objection" id="objection"></s:textarea></td>
			</s:else>
	</tr>
</table></fieldset></td></tr>
