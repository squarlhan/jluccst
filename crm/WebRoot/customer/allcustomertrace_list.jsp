	...
	var _customer_submit = {
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				parent.parent.parent.tipsWindown("添加跟进信息","iframe:customer/allCustomerTraceInfo.action?deptId=<s:property value='deptId'/>&customerId=" + $("#customerId_t").val(),"800","500","true","","true","no");
...
<table width="100%" style="height:100%;" border="0" cellspacing="5" cellpadding="0">
  <tr>
	...
	<tr>  		
		...
		<td style="width:80px"><s:select list="listTraceOption" listKey="id" listValue="name" value="traceOption" 
