	...
	var _customer_submit = {
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				parent.parent.parent.tipsWindown("添加跟进信息","iframe:customer/myCustomerTraceInfo.action?customerId=" + $("#customerId_t").val(),"800","500","true","","true","no");
			...
			$("#searchBtn").click(function(){
				...
				form1.action = "myCustomerTraceList.action";
				form1.submit();
