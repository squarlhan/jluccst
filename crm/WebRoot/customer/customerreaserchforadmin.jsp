...
<html>
			...
			/**
	  		...
	  		$('a[name="nosearch"]').each(function(){
	  			$(this).click(function(){
	  				...
	  				$("#form1").attr("action",url+"&provinceId+"+$("#provinceId").val());
	  				$("#form1").submit();
	  			});
	  		});
		});
  ...
  <body>
 <s:form id="form1" name="form1" method="post" theme="simple" action="customerSearchForAdminAction.action">
            ...
            <td height="26" align="center" bgcolor="#FFFFFF"><s:property value="address"/></td>
	          <td height="26" colspan="2" align="center" bgcolor="#FFFFFF"  nowrap="nowrap">
				<s:url id="nosearch_url" action="toNoSearchCustomerForAdminAction.action">   
	         	...
	         	<a name="nosearch" href="javascript:void(0);" url="${nosearch_url}"><font color="red"><strong>设为不可用</strong></font></a>  
	          </td>
        </tr>
        </s:iterator>        
        <tr>
