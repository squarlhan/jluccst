...
<html>
  ...
  <body>
 <s:form id="form1" name="form1" method="post" theme="simple" action="customerSearchInCompanyAction.action">
        ...
        <td height="26" align="center" bgcolor="#FFFFFF" >  
            ...
            <td height="26" align="left" bgcolor="#FFFFFF"><s:property value="address"/></td>
	          <td height="26" colspan="2" align="center" bgcolor="#FFFFFF"  nowrap="nowrap">
				<s:url id="edit_url" action="toCustomerForInCompanyrAction.action"> 
