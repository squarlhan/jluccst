							...
							<td style="height: 36px;">
								<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#d5e4fd">
									...
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF">
											<s:textfield id="txt_goodsPrice" name="goodsInfoBase.goodsPrice" onpaste="return false" cssStyle="width: 250px;ime-mode:disabled" maxlength="100" onKeyPress="if((event.keyCode<48 || event.keyCode>57) && event.keyCode!=46 || /\.\d\d$/.test(value))event.returnValue=false" ></s:textfield>
											<font color="red">*</font>
										</td>
									</tr>
									<tr>
