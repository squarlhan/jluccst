						 ...
						 <span id="myspan">
							<s:iterator value="sellDutyList" status="obj">
								...
								<s:if test="id==monthlyItemInfo.sellDutyId &&  numberType==true">
									<span id="mydiv"><strong>额度：</strong><s:textfield  tabindex="-1"  id="txt_sellTarget" name="monthlyItemInfo.sellTarget" cssStyle="width: 160px;" cssClass="currenciesOnly"   maxlength="25"></s:textfield>元</span>
								</s:if>
							</s:iterator>
						</span>
					</td>
