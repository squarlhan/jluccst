								...
								<span onmousemove="this.setCapture();" onmouseout="this.releaseCapture();" onfocus="this.blur();"> 
									<tr>
										...
										<td height="26" align="left" bgcolor="#FFFFFF" >
											<s:select tabindex="-1" id="sel_personId"   name="monthlyMainInfo.personId" list="userList"  listKey="id"  listValue="userCName"  cssStyle="width: 160px;" ></s:select>
										</td>
										<td height="26" align="right" bgcolor="#FFFFFF">
											<strong>职务：</strong>
										</td>
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="3">
											<s:textfield  tabindex="-1"  id="txt_position" name="monthlyMainInfo.position" cssStyle="width: 160px;" maxlength="25"></s:textfield>
										</td>
									</tr>
									<tr>
										<td height="26" align="right" bgcolor="#FFFFFF">
										...
										<td height="26" align="left" bgcolor="#FFFFFF">
												<s:select  tabindex="-1"  id="sel_dept"  name="monthlyMainInfo.deptId" list="deptList" listKey="id"  listValue="deptName" cssStyle="width: 160px;" ></s:select>
										</td>
										<td height="26" align="right" bgcolor="#FFFFFF">
											<strong>直接上级：</strong>
										</td>
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="3">
											<s:textfield  tabindex="-1"  id="txt_superior" name="monthlyMainInfo.superior" cssStyle="width: 160px;" maxlength="25"></s:textfield>
										</td>
									</tr>
									<tr>
										<td height="26" align="right" bgcolor="#FFFFFF">
										...
										<td height="26" align="left" bgcolor="#FFFFFF" >
											<s:textfield  tabindex="-1"  id="txt_planInterzone_begin" name="monthlyMainInfo.planInterzoneBegin" cssStyle="width: 160px;" maxlength="25"></s:textfield>
										</td>
										<td height="26" align="right" bgcolor="#FFFFFF">
											<strong>计划结束时间：</strong>
										</td>
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="3">
											<s:textfield  tabindex="-1"  id="txt_planInterzone_end" name="monthlyMainInfo.planInterzoneEnd" cssStyle="width: 160px;" maxlength="25"></s:textfield>
										</td>
									</tr>
									<tr>
										<td height="26" align="right" bgcolor="#FFFFFF">
										...
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="8">
											<s:textfield  tabindex="-1" id="txt_checker"  name="monthlyMainInfo.checker" cssStyle="width: 160px;" maxlength="25"></s:textfield>
										</td>
									</tr>
									<tr>
										<td height="26" align="right" bgcolor="#FFFFFF">
										...
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="8">
											<s:textarea  tabindex="-1"  id="txt_nextMonthKeystone" name="monthlyMainInfo.nextMonthKeystone" cssStyle="width: 540px;height:100px;resize:none;" maxlength="500"></s:textarea>
										</td>
									</tr>
									<tr>
										<td height="26" align="right" bgcolor="#FFFFFF">
										...
										<td height="26" align="left" bgcolor="#FFFFFF" colspan="8">
											<s:textarea  tabindex="-1"  id="txt_companyKeystone" name="monthlyMainInfo.companyKeystone" cssStyle="width: 540px;height:100px;resize:none;" maxlength="500"></s:textarea>
										</td>
									</tr>
									</span>
									<tr>
