...
<%
	...
	String src="openViewMonthlyMainInfoAction.action";
	if(mainInfoId!=null && !mainInfoId.equals("")){
		mainInfoId = "?mainInfoId="+mainInfoId;
		src="openViewMonthlyMainInfoAction.action";
	}else{
		mainInfoId="";
	}
	src=src+mainInfoId;
...
<div id="tt" class="tabs-container">
	<div title="月计划基本信息"  style="padding: 1px; display: none;" id="main">
	...
	<div title="月计划明细"  style="padding: 1px; display:none;" id="item">
		<iframe id="iframe2"  scrolling="auto" frameborder="0" style="width:100%; height:100%" src="about:blank" url="openMonthlyItemListViewAction.action<%=mainInfoId %>"/></iframe>
	</div>
</div>
</body>
</html>
