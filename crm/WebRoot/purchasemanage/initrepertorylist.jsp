...
-->
	...
	$(function() {
		...
		$("#addbtn").click(
				function() {
					parent.parent.tipsWindown("添加初始库存","iframe:<%=path%>/initRepertoryAction!showInitRepertoryInfo.action?initRepertory.id=","460", "300","true","","true","no");
					parent.parent.$("#windown-close").bind('click',function(){
						window.location.href="<%=path%>/showInitRepertoryListAction.action";
					});
				});
		$.fn.checkall("cbk_all");
		$.fn.uncheckall("ids", "cbk_all");
  		...
  		$('a[name="edit"]').each(function(){
  			$(this).click(function(){
  				...
  				parent.parent.tipsWindown("修改初始库存","iframe:"+url ,"460","300","true","","true","no");
  				parent.parent.$("#windown-close").bind('click',function(){
  					window.location.href="<%=path%>/showInitRepertoryListAction.action";
				});
  			});
  		...
  		$("#deletepointbtn").click(function(){
				var url = "initRepertoryAction!deleteInitRepertory.action";
							...
							<s:iterator value="pagination.data" status="obj">
								<tr>
									...
									<td height="26" colspan="2" align="center" bgcolor="#FFFFFF">
										<s:url id="edit_url" action="initRepertoryAction!showInitRepertoryInfo.action">   
											<s:param name="initRepertory.id" value="id"></s:param>   
										</s:url>
										<s:url id="delete_url" action="initRepertoryAction!deleteInitRepertory.action">   
