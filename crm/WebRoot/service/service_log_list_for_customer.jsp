	...
	<head>
		...
		$(function(){
			...
			$("#addbtn").click(function(){
				parent.parent.tipsWindown("添加服务记录","iframe:${pageContext.request.contextPath}/service/servicelogbycustomer.action?companyId=" + $("#companyId").val(),"785","550","true","","true","no");
